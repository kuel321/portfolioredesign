...
export default function Work() {
  return (
    <motion.div animate={{opacity:1}} initial={{opacity: 0}} transition={{duration: 2}} className='component-container-main work'>
    ...
    <motion.div className="component-container work">
     ...
     <div className='work-cards-container'>
        <div className='work-card'>
          ...
          <a href='https://thegrillonthird.com'> <img className='work-img' src={example1}></img></a>
            </motion.div>
            <div className='work-card-description-container'>
               ...
               <motion.a initial={{background: "#29221d"}} whileHover={{background: "#567095ff", color: "#ffffff"}} href="https://thegrillonthird.com" className='view-site-link'>View Site</motion.a>
            </div>
        </div>

        <div className='work-card'>
            <motion.div whileHover={{scale: 1.04}} whileTap={{ scale: 0.99 }} className='work-img-container'>
          <a href='https://keithalbee.com/'> <img className='work-img' src={example2}></img></a>
            </motion.div>
            <div className='work-card-description-container'>
               <h1 className='work-title'>
                Keith Albee
               ...
               <motion.a initial={{background: "#622203"}} whileHover={{background: "#567095ff", color: "#ffffff"}} href="https://keithalbee.com/" className='view-site-link'>View Site</motion.a>
            </div>
        </div>
        ...
        <div className='work-card'>
            <motion.div whileHover={{scale: 1.04}} whileTap={{ scale: 0.99 }} className='work-img-container'>
          <a href='https://keithalbee.com/'> <img className='work-img' src={example4}></img></a>
            </motion.div>
            <div className='work-card-description-container'>
               <h1 className='work-title'>
                MinGO
               ...
               <motion.a initial={{background: "#079ace"}} whileHover={{background: "#567095ff", color: "#ffffff"}} href="https://keithalbee.com/" className='view-site-link'>View Site</motion.a>
            </div>
        </div>

        <div className='work-card'>
            <motion.div whileHover={{scale: 1.04}} whileTap={{ scale: 0.99 }} className='work-img-container'>
          <a href='https://keithalbee.com/'> <img className='work-img' src={example3}></img></a>
            </motion.div>
            <div className='work-card-description-container'>
               <h1 className='work-title'>
                Garden Park Rentals
               ...
               <motion.a initial={{background: "#619775"}} whileHover={{background: "#567095ff", color: "#ffffff"}} href="https://keithalbee.com/" className='view-site-link'>View Site</motion.a>
            </div>
        </div>
